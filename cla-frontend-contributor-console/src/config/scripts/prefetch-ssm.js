...
const configVarArray = ['auth0-clientId', 'auth0-domain', 'cla-api-url', 'corp-console-link', 'cla-logo-s3-url', 'lfx-header', 'lfx-footer', 'lfx-header-enabled', 'landing-page','auth0-platform-api-gw'];
