...
GITHUB_PROJECT_NAME = 'edouardpoitras'
# The GitLab user used for testing purposes.
GITLAB_PROJECT_NAME = 'eddie'
...
github_project.set_project_id(GITHUB_PROJECT_NAME)
github_project.set_project_name('Test GitHub Project')
github_project.save()
gitlab_project = get_project_instance()
gitlab_project.set_project_id(GITLAB_PROJECT_NAME)
gitlab_project.set_project_name('Test GitLab Project')
gitlab_project.save()
# Document
...
document.set_document_revision(1)
...
github_project.save()
gitlab_project.add_project_individual_document(document)
gitlab_project.save()
cla.log.info('Done')
