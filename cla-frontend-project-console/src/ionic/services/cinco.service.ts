...
export class CincoService {
  ...
  getAllMockProjects() {
    return Observable.of([this.linux, this.hyperledger]);
  }
  ...
  createMainProjectGroup(projectId) {
    return this.http.post(this.cincoApiUrl + '/project/' + projectId + '/mailing/groups', null).map(res => res.json());
  }
  ...
  getGroupPrivacy(projectId) {
    ...
    return this.http.get(this.cincoApiUrl + '/project/' + projectId + '/mailing/lists/privacy').map(res => res.json());
  }

  createProjectGroup(projectId, group) {
    return this.http.post(this.cincoApiUrl + '/project/' + projectId + '/mailing/lists', group).map(res => res.json());
  }
