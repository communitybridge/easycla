...
const configVarArray = ['auth0-clientId', 'auth0-domain', 'cla-api-url', 'gh-app-public-link', 'cla-logo-s3-url', 'proj-console-link', 'lfx-header', 'lfx-footer', 'lfx-header-enabled', 'landing-page'];
