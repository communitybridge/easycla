...
class LFGroup:
    ...
    def _get_access_token(self):
        ...
        try:
            ...
            cla.log.warning('Unable to get access token for client id: {} using url: {}, error: {}'.
                            format(self.client_id, oauth_url, e))
            return None
    ...
    def get_group(self, group_id):
        ...
        try:
            ...
            cla.log.warning('Unable to get group id: {} using url: {}, error: {}'.
                            format(group_id, get_group_url, e))
    ...
    def add_user_to_group(self, group_id, username):
        cla.log.debug('Attempting to add user: {} to group: {}'.format(username, group_id))
        access_token = self._get_access_token()
        if access_token is None:
            return {'error': 'Unable to retrieve access token'}
        ...
        try:
            ...
            cla.log.warning('Unable to update group id: {} using url: {}, error: {}'.
                            format(group_id, add_user_url, e))
        ...
        if response.status_code == 200:
            ...
            cla.log.warning('LFGroup; Failed adding user %s into group %s', username, str(group_id))
