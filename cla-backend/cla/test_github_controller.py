...
from cla.controllers.github import get_org_name_from_installation_event
...
class TestGitHubController(unittest.TestCase):
    ...
    def test_get_org_name_from_event(self) -> None:
        ...
        self.assertEqual('Linux Foundation', get_org_name_from_installation_event(body), 'GitHub Org Matches')
    ...
    def test_get_org_name_from_event_2(self) -> None:
        ...
        self.assertEqual('grpc', get_org_name_from_installation_event(body), 'GitHub Org Matches grpc example')
