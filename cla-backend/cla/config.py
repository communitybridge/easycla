...
# Storage Service.
STORAGE_SERVICE = 'S3Storage' #: The storage service to use for storing CLAs. `S3Storage` or `LocalStorage` 
...
S3_BUCKET = 'cla-files-bucket' #: AWS S3 bucket used to store CLA files - must be unique.
