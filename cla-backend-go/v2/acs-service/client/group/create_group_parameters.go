...
// WithEmptyHeader adds the emptyHeader to the create group params
func (o *CreateGroupParams) WithEmptyHeader(emptyHeader string) *CreateGroupParams {
	o.SetEmptyHeader(emptyHeader)
	return o
}

// SetEmptyHeader adds the emptyHeader to the create group params
func (o *CreateGroupParams) SetEmptyHeader(emptyHeader string) {
	o.EmptyHeader = emptyHeader
}

// WithXEMAIL adds the xEMAIL to the create group params
func (o *CreateGroupParams) WithXEMAIL(xEMAIL *string) *CreateGroupParams {
	o.SetXEMAIL(xEMAIL)
	return o
}

// SetXEMAIL adds the xEMAIL to the create group params
func (o *CreateGroupParams) SetXEMAIL(xEMAIL *string) {
	o.XEMAIL = xEMAIL
}
...
// WithXUSERNAME adds the xUSERNAME to the create group params
func (o *CreateGroupParams) WithXUSERNAME(xUSERNAME *string) *CreateGroupParams {
	o.SetXUSERNAME(xUSERNAME)
	return o
}

// SetXUSERNAME adds the xUSERNAME to the create group params
func (o *CreateGroupParams) SetXUSERNAME(xUSERNAME *string) {
	o.XUSERNAME = xUSERNAME
}

// WithGroup adds the group to the create group params
func (o *CreateGroupParams) WithGroup(group *models.CreateGroup) *CreateGroupParams {
	o.SetGroup(group)
	return o
}

// SetGroup adds the group to the create group params
func (o *CreateGroupParams) SetGroup(group *models.CreateGroup) {
	o.Group = group
}
