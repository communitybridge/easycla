...
// WithEmptyHeader adds the emptyHeader to the get group params
func (o *GetGroupParams) WithEmptyHeader(emptyHeader string) *GetGroupParams {
	o.SetEmptyHeader(emptyHeader)
	return o
}

// SetEmptyHeader adds the emptyHeader to the get group params
func (o *GetGroupParams) SetEmptyHeader(emptyHeader string) {
	o.EmptyHeader = emptyHeader
}

// WithXEMAIL adds the xEMAIL to the get group params
func (o *GetGroupParams) WithXEMAIL(xEMAIL *string) *GetGroupParams {
	o.SetXEMAIL(xEMAIL)
	return o
}

// SetXEMAIL adds the xEMAIL to the get group params
func (o *GetGroupParams) SetXEMAIL(xEMAIL *string) {
	o.XEMAIL = xEMAIL
}
...
// WithXUSERNAME adds the xUSERNAME to the get group params
func (o *GetGroupParams) WithXUSERNAME(xUSERNAME *string) *GetGroupParams {
	o.SetXUSERNAME(xUSERNAME)
	return o
}

// SetXUSERNAME adds the xUSERNAME to the get group params
func (o *GetGroupParams) SetXUSERNAME(xUSERNAME *string) {
	o.XUSERNAME = xUSERNAME
}

// WithID adds the id to the get group params
func (o *GetGroupParams) WithID(id string) *GetGroupParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get group params
func (o *GetGroupParams) SetID(id string) {
	o.ID = id
}
