      ...
      <div className="container">
        <p>
          ...
          <Link to="https://communitybridge.dev.platform.linuxfoundation.org/acceptable-use">
            <a target="_blank" href="https://communitybridge.dev.platform.linuxfoundation.org/acceptable-use">Acceptable Use Policy</a>
          </Link>
          |
          <Link to="https://communitybridge.dev.platform.linuxfoundation.org/service-terms">
            <a target="_blank" href="https://communitybridge.dev.platform.linuxfoundation.org/service-terms">Service-Specific Terms</a>
          </Link>
          |
           <Link to="https://communitybridge.dev.platform.linuxfoundation.org/platform-use-agreement">
            <a target="_blank" href="https://communitybridge.dev.platform.linuxfoundation.org/platform-use-agreement"> Platform Use Agreement</a>
          </Link>
          |
          <Link to="https://communitybridge.org/guide/">
            <a target="_blank" href="https://communitybridge.org/guide/"> CommunityBridge People Guide</a>
          </Link>
          |
          <Link to="https://www.linuxfoundation.org/privacy/">
            <a target="_blank" href="https://www.linuxfoundation.org/privacy/">Privacy Policy</a>
          </Link>
          <br /><br />
