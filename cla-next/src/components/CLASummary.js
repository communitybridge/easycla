          ...
          <div className="row">
            <div className="col-12 col-md-6">
              ...
              <p className="cla-paragraph pb-4">
                For contributors, maintainers, and the companies supporting their own developers, Contributor License
                Agreements (CLAs) can seem like they just get in the way of growing the community around a project
              </p>
              ...
              <ul className="cla-list-wrapper">
                ...
                <li className="cla-list">
                  <span>
                    <span>
                      Corporations and projects can save time by reducing manual steps managing CLAs and their
                      signatures
                    </span>
                  </span>
                </li>
                <li className="cla-list">
                  <span>
                    <span>
                      Both Individual and Corporate CLA signing can be enforced for developers contributing to a project
