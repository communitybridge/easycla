          ...
          <div className="row">
            <div className="col-12 col-md-4">
              <div className="cla-step-col">
                <div className="center-item">
                  <div
                    className="nectar_icon_wrap"
                    data-style="default"
                    data-draw=""
                    data-border-thickness="2px"
                    data-padding="20px"
              ...
              <div className="cla-step-col">
                ...
                <div className="center-item">
                  <Link href={this.setLink('proj-console-link')}>
                    <a>
                      <Button variant="primary"> Sign In as Project Manager</Button>
                    </a>
                  </Link>
                  <Link href="https://docs.google.com/forms/d/e/1FAIpQLSdnTk_9xjk7YoiX_FcPEqsFytsLMcT8OzYUbK6TsYopR1XhdA/viewform">
                    <a target="_blank">
                      <Button variant="success"> request to add project</Button>
                    </a>
                  </Link>
                </div>
              </div>
            ...
            <div className="col-12 col-md-4">
              <div className="cla-step-col">
                ...
                <p>
                  Enable all your developers to contribute code easily and quickly while remaining compliant with
                ...
                <ul>
                  ...
                  <li className="cla-list">
                    Enable your signatories and contributors to sign CLAs using DocuSign&reg; electronic signatures
                  </li>
                  <li className="cla-list">
                    <span>
                      Enforce signing of the Corporate CLA by your developers without slowing them down with manual
                      bureaucracy
                    </span>
                  </li>
                </ul>
                <div className="center-item">
                  <Link href={this.setLink('corp-console-link')}>
                    <a>
                      <Button variant="primary">Sign in as CLA Manager</Button>
                    </a>
                  </Link>
                </div>
              </div>
