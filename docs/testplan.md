# testplan
 ...
 [![CommunityBridge EasyCLA logo](https://project.dev.lfcla.com/assets/logo/cp_app_easycla.svg)](https://lfcla.com/)
...
* [Testplan](testplan.md#testplan)
  * [Table of Contents](testplan.md#table-of-contents)
  * [Test Requirements](testplan.md#test-requirements)
  * [Project Management console](testplan.md#project-management-console)
    * [Project Manager Creates/Edits a Contract Group](testplan.md#project-manager-createsedits-a-contract-group)
  ...
  * [Contributor console](testplan.md#contributor-console)
    ...
    * [Gerrit CLA Flow](testplan.md#gerrit-cla-flow)

### Test Requirements

* App URLS
  * Landing page: [https://test.lfcla.com](https://test.lfcla.com)
  * Project Management Console : [https://project.test.lfcla.com](https://project.test.lfcla.com)
  * Corporate Console : [https://corporate.test.lfcla.com](https://corporate.test.lfcla.com)
...
| Create CLA group | Create CLA group by clicking **ADD CLA GROUP** button.   On form submission project detail page list CLA group with selected CLA types. | ✅ |
| Connect Github Organization | Project manager should be able connect their Github organization to CLA project by installing GH app in their GH org.   Once installed **GitHub Organizations** section should list the organization. | ✅ |
...
| Accept CLA manager join requests | CLA manager can request to join exiting company. It should get listed in _Pending Invites_ section of Company detail page. | ✅ |
...
| Add CLA manager for a CCLA | Multiple manager can manage a signed CCLA and they can be added in _CLA Managers_ section of CCLA detail page. | ✅ |
| Employee Acknowledgments | List of corporate contributors who confirmed association with company should be list in _Employee Acknowledgments_ section | ✅ |
