...
class SigningService(object):
    ...
    def request_signature(self, project_id, user_id, return_url, callback_url=None):
        ...
        :param project_id: The ID of the project for this agreement.
        :type project_id: string
        :param user_id: The ID of the user for this agreement.
        :type user_id: string
    ...
    def populate_sign_url(self, agreement, callback_url=None):
        """
        Method used to populate the sign_url field in the agreement object provided.

        Should perform all the necessary steps so that the user simply needs to be sent to
        agreement.get_agreement_sign_url() and the signing process should begin. Modifies the
        agreement object in place.

        Should NOT save the agreement object.

        :param agreement: The Agreement object in question.
    ...
    def signed_callback(self, content, repository_id, change_request_id):
        ...
        Should handle things like updating the agreement object to 'signed'.

        :param content: The POST body of the callback.
        :type content: string
        :param repository_id: The ID of the repository that users are signing the agreement for.
